...
class Home extends BaseController
{
    ...
    {
// Var_dump('constant SECOND');
// echo view('DAY');

var_dump(env('app.baseURL'));
echo '</br>';
...
var_dump(MINUTE); //Globle Constant
echo '</br>';

var_dump(DAY); //Globle Constant
echo '</br>';

var_dump(FCPATH); //Globle Constant
echo '</br>';

var_dump(env('custome_env'));
echo '</br>';

var_dump(env('customize_env'));
echo '</br>';

var_dump(env('ninde','what happend')); //By bydefaulte
echo '</br>';

exit;
echo view('hi'); //Globle Function  echo model() & echo view('hi');




// //For Delete oprations
